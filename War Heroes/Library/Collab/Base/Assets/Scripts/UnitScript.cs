...
public class UnitScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            print("enemyTurn" + GameObject.Find("Grid").GetComponent<unitTurn>().curEnemyUnitTurnId);
            if (GameObject.Find("Grid").GetComponent<unitTurn>().curEnemyUnitTurnId != 0)
            {
                ...
                var enemyLocation = GameObject.FindGameObjectWithTag(GameObject.Find("Grid").GetComponent<unitTurn>().curEnemyUnitTurnId.ToString()).GetComponent<UnitScript>().transform.position;
                //Vector2.MoveTowards(enemyLocation, myLocation, 200*Time.deltaTime / 5);

                //var point = GameObject.Find("Tilemap").GetComponent<Tilemap>().WorldToCell(hit.point);
                //var point2 = GameObject.Find("Tilemap").GetComponent<Tilemap>().CellToWorld(myLocation);
                //var point3 = new Vector3(point2.x + 0.16f, point2.y + 0.16f, point2.z);
                //print("hit" + hit.point);
                //print("point2" + point3);
                //print("agent" + agent.agentTypeID);
                //agent.SetDestination(myLocation);
            }
        }
        **/
    }
    ...
    void setAttributes()
    {
        ...
        else if (unitName == "Socceress(Clone)")
        {
