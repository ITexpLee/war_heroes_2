    ...
    void OnCollisionEnter2D(Collision2D col)
	{
        ...
        if (instantiator == "7")
            if (col.gameObject.tag == "collider" || col.gameObject.tag == "2" || col.gameObject.tag == "3" || col.gameObject.tag == "4" || col.gameObject.tag == "5" || col.gameObject.tag == "6" || col.gameObject.tag == "1" || col.gameObject.tag == "8")
                Destroy(gameObject);
        if (instantiator == "8")
            if (col.gameObject.tag == "collider" || col.gameObject.tag == "2" || col.gameObject.tag == "3" || col.gameObject.tag == "4" || col.gameObject.tag == "5" || col.gameObject.tag == "6" || col.gameObject.tag == "7" || col.gameObject.tag == "")
                Destroy(gameObject);
    }
