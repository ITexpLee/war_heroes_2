...
public class Agent6 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //print("Agent 1");
        if (GameObject.Find("Grid").GetComponent<unitTurn>().curEnemyUnitTurnId == 6)
        {
            ...
            GameObject.Find("Grid").GetComponent<unitTurn>().moveEnemyUnit(7);
            GameObject.Find("Grid").GetComponent<unitTurn>().curEnemyUnitTurnId = 7;
            //unit turn done
